...
public sealed class InquisitorOptions : AbstractOptionGroup<InquisitorRole>
{
    ...
    public ModdedNumberOption InquireCooldown { get; set; } = new("Inquire Cooldown", 25f, 10f, 60f, 2.5f, MiraNumberSuffixes.Seconds)
    {
        Visible = () => !OptionGroupSingleton<InquisitorOptions>.Instance.CantInquire
    };
    
    public ModdedNumberOption MaxUses { get; set; } = new("Max Number Of Inquires", 5f, 1f, 15f, 1f, MiraNumberSuffixes.None, "0")
    {
        Visible = () => !OptionGroupSingleton<InquisitorOptions>.Instance.CantInquire
    };
    
    public ModdedNumberOption AmountOfHeretics { get; set; } = new("Amount of Heretics Needed", 3f, 3f, 5f, 1f, MiraNumberSuffixes.None, "0")
    {
        Visible = () => !OptionGroupSingleton<InquisitorOptions>.Instance.CantInquire
    };
}
