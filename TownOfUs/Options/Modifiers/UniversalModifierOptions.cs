...
public sealed class UniversalModifierOptions : AbstractOptionGroup
{
    ...
    public ModdedNumberOption FlashChance { get; } = new ModdedNumberOption("Flash Chance", 0, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
    ...
    public ModdedNumberOption GiantChance { get; } = new ModdedNumberOption("Giant Chance", 0, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
    ...
    public ModdedNumberOption ImmovableChance { get; } = new ModdedNumberOption("Immovable Chance", 0, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
    ...
    public ModdedNumberOption MiniChance { get; } = new ModdedNumberOption("Mini Chance", 0, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
    ...
    public ModdedNumberOption RadarChance { get; } = new ModdedNumberOption("Radar Chance", 0, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
    ...
    public ModdedNumberOption ShyChance { get; } = new ModdedNumberOption("Shy Chance", 0, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
    ...
    public ModdedNumberOption SixthSenseChance { get; } = new ModdedNumberOption("Sixth Sense Chance", 0, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
    ...
    public ModdedNumberOption SleuthChance { get; } = new ModdedNumberOption("Sleuth Chance", 0, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
    ...
    public ModdedNumberOption SatelliteChance { get; } = new ModdedNumberOption("Satellite Chance", 0, 0, 100f, 10f, MiraNumberSuffixes.Percent)
    {
