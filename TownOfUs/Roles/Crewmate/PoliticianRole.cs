...
public sealed class PoliticianRole(IntPtr cppPtr) : CrewmateRole(cppPtr), ITouCrewRole, IWikiDiscoverable, IDoomable
{
    ...
    public string RoleDescription => $"Campaign To Become {TouLocale.Get(TouNames.Mayor, "Mayor")}!";
    public string RoleLongDescription => $"Spread your campaign to become {TouLocale.Get(TouNames.Mayor, "Mayor")}!";
    ...
    public void Click(PlayerVoteArea voteArea, MeetingHud __)
    {
        ...
        else
        {
            ...
            var title = $"<color=#{TownOfUsColors.Mayor.ToHtmlStringRGBA()}>{TouLocale.Get(TouNames.Politician, "Politician")} Feedback</color>";
    ...
    {
        return $"The {RoleName} is a Crewmate Power role that can reveal themselves to the crew as {TouLocale.Get(TouNames.Mayor, "Mayor")}, given that they have campaigned at least half of the crewmates."
    ...
    public List<CustomButtonWikiDescription> Abilities { get; } = [
        ...
        new("Reveal (Meeting)",
            $"If you reveal and you have more than half of the crewmates campaigned (or no other crewmates remain), you will become {TouLocale.Get(TouNames.Mayor, "Mayor")}! Otherwise, your ability will fail and you " + (OptionGroupSingleton<PoliticianOptions>.Instance.PreventCampaign ? "cannot" : "can") + " campaign the following round.",
