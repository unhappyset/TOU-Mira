...
{
    public static CustomColor Watermelon { get; } = new(TouLocale.Get("Watermelon", "Watermelon"),
    ...
    public static CustomColor Chocolate { get; } = new(TouLocale.Get("Chocolate", "Chocolate"),
    ...
    public static CustomColor SkyBlue { get; } = new(TouLocale.Get("SkyBlue", "Sky Blue"),
    ...
    public static CustomColor Beige { get; } = new(TouLocale.Get("Beige", "Beige"),
    ...
    public static CustomColor Magenta { get; } = new(TouLocale.Get("Magenta", "Magenta"),
    ...
    public static CustomColor SeaGreen { get; } = new(TouLocale.Get("SeaGreen", "Sea Green"),
    ...
    public static CustomColor Lilac { get; } = new(TouLocale.Get("Lilac", "Lilac"),
    ...
    public static CustomColor Olive { get; } = new(TouLocale.Get("Olive", "Olive"),
    ...
    public static CustomColor Azure { get; } = new(TouLocale.Get("Azure", "Azure"),
    ...
    public static CustomColor Jungle { get; } = new(TouLocale.Get("Jungle", "Jungle"),
    ...
    public static CustomColor Mint { get; } = new(TouLocale.Get("Mint", "Mint"),
    ...
    public static CustomColor Chartreuse { get; } = new(TouLocale.Get("Chartreuse", "Chartreuse"),
    ...
    public static CustomColor Macau { get; } = new(TouLocale.Get("Macau", "Macau"),
    ...
    public static CustomColor Tawny { get; } = new(TouLocale.Get("Tawny", "Tawny"),
    ...
    public static CustomColor Gold { get; } = new(TouLocale.Get("Gold", "Gold"),
    ...
    public static CustomColor Snow { get; } = new(TouLocale.Get("Snow", "Snow"),
    ...
    public static CustomColor Turquoise { get; } = new(TouLocale.Get("Turquoise", "Turquoise"),
    ...
    public static CustomColor Nacho { get; } = new(TouLocale.Get("Nacho", "Nacho"),
    ...
    public static CustomColor Blood { get; } = new(TouLocale.Get("Blood", "Blood"),
    ...
    public static CustomColor Grass { get; } = new(TouLocale.Get("Grass", "Grass"),
    ...
    public static CustomColor Mandarin { get; } = new(TouLocale.Get("Mandarin", "Mandarin"),
    ...
    public static CustomColor Glass { get; } = new(TouLocale.Get("Glass", "Glass"),
    ...
    public static CustomColor Midnight { get; } = new(TouLocale.Get("Midnight", "Midnight"),
    ...
    public static CustomColor Steel { get; } = new(TouLocale.Get("Steel", "Steel"),
    ...
    public static CustomColor Silver { get; } = new(TouLocale.Get("Silver", "Silver"),
    ...
    public static CustomColor Shimmer { get; } = new(TouLocale.Get("Shimmer", "Shimmer"),
    ...
    public static CustomColor Crimson { get; } = new(TouLocale.Get("Crimson", "Crimson"),
    ...
    public static CustomColor Charcoal { get; } = new(TouLocale.Get("Charcoal", "Charcoal"),
    ...
    public static CustomColor Violet { get; } = new(TouLocale.Get("Violet", "Violet"),
    ...
    public static CustomColor Denim { get; } = new(TouLocale.Get("Denim", "Denim"),
    ...
    public static CustomColor CottonCandy { get; } = new(TouLocale.Get("CottonCandy", "Cotton Candy"),
    ...
    public static CustomColor Rainbow { get; } =
        new(TouLocale.Get("Rainbow", "Rainbow"), new Color32(0, 0, 0, byte.MaxValue))
        {
            ColorBrightness = CustomColorBrightness.Lighter
        };
}