...
public static class TouAssets
{
    ...
    public static LoadableAsset<Sprite> SwapActive { get; } = new LoadableResourceAsset($"{ShortPath}.SwapActive.png", 254);
    public static LoadableAsset<Sprite> SwapInactive { get; } = new LoadableResourceAsset($"{ShortPath}.SwapDisabled.png", 254);
    public static LoadableAsset<Sprite> RevealButtonSprite { get; } = new LoadableResourceAsset($"{ShortPath}.Reveal.png", 254);
    public static LoadableAsset<Sprite> RevealCleanSprite { get; } = new LoadableResourceAsset($"{ShortPath}.RevealClean.png", 254);
    ...
    public static LoadableAsset<Sprite> ImitateSelectSprite { get; } = new LoadableResourceAsset($"{ShortPath}.ImitateSelect.png", 254);
    public static LoadableAsset<Sprite> ImitateDeselectSprite { get; } = new LoadableResourceAsset($"{ShortPath}.ImitateDeselect.png", 254);
